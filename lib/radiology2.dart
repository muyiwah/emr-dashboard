...
class RadiologyHomePage2 extends StatefulWidget {
  const RadiologyHomePage2({Key? key}) : super(key: key);

  @override
  State<RadiologyHomePage2> createState() => _RadiologyHomePage2State();
}

class _RadiologyHomePage2State extends State<RadiologyHomePage2> {
